...
en1_alg = Algorithm.ASTAR
en2_alg = Algorithm.BFS
en3_alg = Algorithm.ASTAR
show_path = True
...
def menu_loop():
    ...
    play_options.add.selector("Character 1", [("Player", Algorithm.PLAYER), ("BFS", Algorithm.BFS),
                                              ("ASTAR", Algorithm.ASTAR), ("BEAM", Algorithm.BEAM), 
                                              ("PARTIAL", Algorithm.PARTIAL_OBSERVATION), 
                                              ("QLEARNING", Algorithm.QLEARNING),
                                              ("None", Algorithm.NONE)], onchange=change_player)
    play_options.add.selector("Character 2", [("ASTAR", Algorithm.ASTAR), ("BFS", Algorithm.BFS),
                                              ("BEAM", Algorithm.BEAM), ("PARTIAL", Algorithm.PARTIAL_OBSERVATION),
                                              ("QLEARNING", Algorithm.QLEARNING),
                                              ("None", Algorithm.NONE)], onchange=change_enemy1)
    play_options.add.selector("Character 3", [("ASTAR", Algorithm.ASTAR), ("BFS", Algorithm.BFS),
                                              ("BEAM", Algorithm.BEAM), ("PARTIAL", Algorithm.PARTIAL_OBSERVATION),
                                              ("QLEARNING", Algorithm.QLEARNING),
                                              ("None", Algorithm.NONE)], onchange=change_enemy2,  default=1)
    play_options.add.selector("Character 4", [("ASTAR", Algorithm.ASTAR), ("BFS", Algorithm.BFS),
                                              ("BEAM", Algorithm.BEAM), ("PARTIAL", Algorithm.PARTIAL_OBSERVATION),
                                              ("QLEARNING", Algorithm.QLEARNING),
